...
INSERT INTO `customer` (`title`, `fname`, `lname`, `gen`, `username`, `pass`, `email`, `bank`, `acc_no`, `phone`, `add`, `city`, `coun`, `dob`) VALUES
('Mr.', 'Aditya', 'Bose', 'Male', 'abose', 'adityabose27', 'adityabose27@gmail.com', 'UBI', 12, 'chrisgayle', '24, Richardson Hall', 'Shibpur', 'India', '27-02-95'),
('Mr.', 'Ashish', 'Gupta', 'Male', 'ag123', 'ashish', 'a@gmail.com', 'SBI', 1234, '2423532565', 'afewsfge', 'awrwsef', 'India', ''),
('Mr.', 'Avinash', 'Kumar', 'Male', 'ak123', 'ak123', 'avinashw50w@gmail.com', 'SBI', 12345, '8442845251', 'abc', 'xyz', 'India', '1994-07-24');
